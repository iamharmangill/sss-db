...
async function createPost(todoItem, todoDateAdded, todoStatus, todoDueBy) {
  try {
    const createdtodoItem = await pool.query(`INSERT INTO todo (todoItem, todoDateAdded, todoStatus, todoDueBy) VALUES ('${todoItem}', '${todoDateAdded}', ${todoStatus}, '${todoDueBy}');`)
